    ...
    <div class="row mt-5">
        <div class="col-md-3 pr-3">
            <div class="float-end">
                ...
                <div class="d-flex mt-3">
                    ...
                    <span class="pt-1 text-bold ml-2">Pesanan</span>
                </div>
            </div><br>
        </div>
        ...
        <div class="col-md-9 px-5">
            ...
            <div class="tab-content" id="myTabContent">
                        ...
                        <div class="card p-3">
                            <div class="border-bottom pb-2 d-flex justify-content-between">
                                <div> <i class="fa-solid fa-shop"></i>
                                    <span class="text-bold ml-2"> {{ $p->seller->nama_toko }}</span>
                                </div>
                ...
                <div class="tab-pane fade" id="Selesai" role="tabpanel" aria-labelledby="Selesai-tab">asdK</div>
                <div class="tab-pane fade" id="Batal" role="tabpanel" aria-labelledby="Batal-tab">asdk</div>
            </div>
