                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Seller
                            {{ ucwords(request('condition')) ? ucwords(request('condition')) : 'Approved' }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table class="dataTable table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($sellers as $seller)
                                    <tr>
                                        <td><img src="{{ asset('storage/logo-sellers/' . $seller->logo) }}" alt=""
                                                width="60px"
                                                height="60px"></td>
                                        ...
                                        <td class="text-nowrap text-center">
                                            @if ($seller->is_active == 1)
                                                ...
                                                <form class="d-inline" id="seller-banned-form"
